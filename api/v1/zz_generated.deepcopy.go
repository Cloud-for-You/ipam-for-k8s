...
func (in *ManageKind) DeepCopyInto(out *ManageKind) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManageKind.
func (in *ManageKind) DeepCopy() *ManageKind {
	if in == nil {
		return nil
	}
	out := new(ManageKind)
...
func (in *SubnetSpec) DeepCopyInto(out *SubnetSpec) {
	*out = *in
	if in.UsableIPs != nil {
		in, out := &in.UsableIPs, &out.UsableIPs
